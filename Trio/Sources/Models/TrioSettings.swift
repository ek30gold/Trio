...
struct TrioSettings: JSON, Equatable, Encodable {
    ...
    var homeLayoutStyle: HomeLayoutStyle = .classic
...
extension TrioSettings: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        if let homeLayoutStyle = try? container.decode(HomeLayoutStyle.self, forKey: .homeLayoutStyle) {
            settings.homeLayoutStyle = homeLayoutStyle
        }
